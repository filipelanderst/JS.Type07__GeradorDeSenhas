!(function (n) {
  ...
  function (n, e, t) {
    ...
    var r = function (n, e) {
      ...
      o = function () {
        return String.fromCharCode(r(65, 91));
      },
      i = function () {
        return String.fromCharCode(r(97, 123));
      },
      a = function () {
        return String.fromCharCode(r(48, 58));
      },
      u = function () {
        return ',.;~^[]{}!@#$%*()_+=-'[r(0, ',.;~^[]{}!@#$%*()_+=-'.length)];
      };
    var c = document.querySelector('.senha-gerada'),
      s = document.querySelector('.qtd-caracteres'),
      l = document.querySelector('.chk-maiusculas'),
      f = document.querySelector('.chk-minusculas'),
      p = document.querySelector('.chk-numeros'),
      d = document.querySelector('.chk-simbolos'),
      h = document.querySelector('.gerar-senha');
    t(1);
    h.addEventListener('click', function () {
      c.innerHTML =
        ...
        })(s.value, l.checked, f.checked, p.checked, d.checked) ||
        'Nada selecionado.';
    });
  },
  function (n, e, t) {
    ...
    function c(n, e) {
      for (var t = 0; t < n.length; t++) {
        ...
        if (i) {
          ...
          for (var u = []; a < r.parts.length; a++) u.push(v(r.parts[a], e));
